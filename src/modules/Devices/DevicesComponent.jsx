            ...
            <div>
                <section className="py-1 h-screen w-screen bg-login_back bg-center bg-no-repeat">
                    <div className="flex justify-end gap-2 items-center p-5">
                        <img onClick={this.logout} src={Logout}
                             className="w-18 h-16 bg-gray-100 rounded-full cursor-pointer p-2"></img>
                    </div>
                    {!this.props.modalState && (
                        <div className="w-full xl:w-8/12 mb-12 xl:mb-0 px-4 mx-auto mt-24">
                            <div
                                className="relative flex flex-col min-w-0 break-words bg-pink-300 w-full mb-6 shadow-lg rounded-3xl ">
                            ...
                            <div className="flex flex-wrap items-center md:justify-between justify-center">
                                <div className="w-full md:w-6/12 px-4 mx-auto text-center">
                                    <div className="text-sm text-blueGray-500 font-semibold py-1">
                                        <button onClick={this.startCodingBtnClick}
                                                className="p-8 shadow-2xl text-3xl hover:bg-purple-900 hover:shadow-sm text-white bg-purple-700 rounded-full ">
                                            Start Coding
                                        </button>
                                    </div>
                                </div>
